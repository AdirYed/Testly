    ...
    ***************************************************************************** */
          ...
          function appendScrollBehaviorToStyleAttribute(element, behavior) {
            ...
            if (existingValueForProperty != null) {
              var replacementProperty =
                STYLE_ATTRIBUTE_PROPERTY_NAME + ":" + existingValueForProperty;
          ...
          function parseScrollBehaviorFromStyleAttribute(element) {
            ...
            if (
              ...
              styleAttributeValue.includes(STYLE_ATTRIBUTE_PROPERTY_NAME)
            ) {
          ...
          function getScrollBehavior(inputTarget, options) {
            ...
            if (options != null && options.behavior === "smooth")
              return "smooth";
            var target =
              "style" in inputTarget ? inputTarget : getScrollingElement();
            var value;
            if ("style" in target) {
          ...
          function disableScrollSnap(scroller) {
            ...
            if (existingResult != null) {
              ...
              secondaryScrollerCachedScrollBehaviorStyleAttributeValue =
                secondaryScroller == null
                  ? undefined
                  : parseScrollBehaviorFromStyleAttribute(secondaryScroller);
              ...
              var secondaryScrollerCachedComputedScrollSnapValue =
                secondaryScroller == null
                  ? undefined
                  : getComputedStyle(secondaryScroller).getPropertyValue(
                      "scroll-snap-type"
                    );
              ...
              if (
                ...
                secondaryScrollerCachedComputedScrollSnapValue === "none"
              ) {
                return NOOP;
              }
            }
            ...
            function resetHandler() {
              ...
              if (
                secondaryScroller != null &&
                secondaryScrollerCachedScrollSnapValue !== undefined
              ) {
          ...
          function getScrollToOptionsWithValidation(optionsOrX, y) {
            ...
            if (!isScrollToOptions(optionsOrX)) {
              return __assign(
                __assign({}, normalizeScrollCoordinates(optionsOrX, y)),
                { behavior: "auto" }
              );
            }
          ...
          function getLocationOrigin(locationLike) {
            ...
            var port =
              locationLike.port != null && locationLike.port.length > 0
                ? ":" + locationLike.port
                : "";
          ...
          function catchNavigation() {
            ...
            window.addEventListener("click", function (e) {
              ...
              var pointsToCurrentPage =
                getLocationOrigin(e.target) === getLocationOrigin(location) &&
              ...
              if (behavior !== "smooth") {
                ...
                // Otherwise, invoke 'scrollTo' instead and provide the scroll coordinates
                  ...
                  var _b = computeScrollIntoView(
                    ...
                    top_1 = _b.top,
                    left = _b.left;
                  getOriginalScrollMethodForKind("scrollTo", this).call(
                    this,
                    left,
                    top_1
                  );
